...
function Example() {
  ...
  const generateCardComponents = (object) => object.map(comp => <Card title = {comp.title} description={comp.description} created={comp.created} imageUrl={comp.url} setNotificationState = {setNotificationState}/>)
  ...
  console.log("HEYEYEY",titleArray)
  return (
    <div className="App">
